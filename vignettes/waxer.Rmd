...
project_views <- map_dfr(
  ...
  granularity = "monthly", start_date = "20160101", end_date = "20200601",
  .id = "language"
)
```
```{r}
...
To obtain the monthly estimated number of unique devices that visited German Wikivoyage from Jan 2018 to May 2020:
...
active_editors_by_wiki <- map_dfr(
  ...
  start_date = "20150101", end_date = "20200601",
  granularity = "monthly",
  .id = "language"
)
```
