...
daily_edits <- map_dfr(
  ...
  start_date = "20200101", end_date = "20200320",
  granularity = "daily",
  .id = "language"
)
...
editing_activity <- daily_edits %>%
  left_join(daily_editors, by = c("language", "date")) %>%
...
What were the top 5 most edited articles by on English Wikipedia in January and February of 2020?
